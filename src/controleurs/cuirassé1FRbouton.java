...
public class cuirassé1FRbouton implements ActionListener {
    FenetreBatailleNaval fn;
    Ship s;
    listepourajoutbateau ls;
    public cuirassé1FRbouton(FenetreBatailleNaval lfn , listepourajoutbateau nls){
        this.fn = lfn;
        ls = nls;
    }
    @Override
    public void actionPerformed(ActionEvent e) { //Permet de positionner le cuirassé français
        ...
        try {
            ...
            try {
                s = new Battleship("cuirasser1fr", coord.toString(), coodfin.toString());
            ...
            JOptionPane.showMessageDialog(fn, "Pas assez de place, un cuirrassé occupe 4 cases", "Erreur", JOptionPane.ERROR_MESSAGE);
